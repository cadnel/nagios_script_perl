...
{		if ($mois<10)
				{
					...
					while (my $ligne=<F>){
						if ($ligne =~/in_list2/i)
							{
								open(OUT,">>D:\\log\\$annee-0$mois-0$jour\\default0$mois.0$jour.txt");
								print OUT "$ligne";
							}
											}
				}
				...
				{		
					...
					while (my $ligne=<F>){
						if ($ligne =~/in_list2/i)
							{
								open(OUT,">>D:\\log\\$annee-$mois-0$jour\\default$mois.0$jour.txt");
								print OUT "$ligne";
							}
											}
				}
			...
			if ($mois<10)
				{
					...
					while (my $ligne=<F>){
						if ($ligne =~/in_list2/i)
							{
								open(OUT,">>D:\\log\\$annee-0$mois-$jour\\default0$mois.$jour.txt");
								print OUT "$ligne";
							}
										}
				}
				...
				{		
					...
					while (my $ligne=<F>){
						if ($ligne =~/in_list2/i)
							{
								open(OUT,">>D:\\log\\$annee-$mois-$jour\\default$mois.$jour.txt");
								print OUT "$ligne";
							}
											}
				}
