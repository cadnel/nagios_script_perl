			...
			if ($mois<10)
				{
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.109./i)
							{
								open(OUT,">>D:\\log\\$annee-0$mois-0$jour\\sig0$mois.0$jour.txt");
								print OUT "$ligne";
							}
											}
				}
				...
				{		
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.109./i)
							{
								open(OUT,">>D:\\log\\$annee-$mois-0$jour\\sig$mois.0$jour.txt");
								print OUT "$ligne";
							}
											}
				}
			...
			if ($mois<10)
				{
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.109./i)
							{
								open(OUT,">>D:\\log\\$annee-0$mois-$jour\\sig0$mois.$jour.txt");
								print OUT "$ligne";
							}
										}
				}
				...
				{		
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.109./i)
							{
								open(OUT,">>D:\\log\\$annee-$mois-$jour\\sig$mois.$jour.txt");
								print OUT "$ligne";
							}
											}
				}
