			...
			if ($mois<10)
				{
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.190./i)
							{
								open(OUT,">>D:\\log\\$annee-0$mois-0$jour\\lux2bis0$mois.0$jour.txt");
								print OUT "$ligne";
							}
											}
				}
				...
				{		
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.190./i)
							{
								open(OUT,">>D:\\log\\$annee-$mois-0$jour\\lux2bis$mois.0$jour.txt");
								print OUT "$ligne";
							}
											}
				}
			...
			if ($mois<10)
				{
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.190./i)
							{
								open(OUT,">>D:\\log\\$annee-0$mois-$jour\\lux2bis0$mois.$jour.txt");
								print OUT "$ligne";
							}
										}
				}
				...
				{		
					...
					while (my $ligne=<F>){
						if ($ligne =~/192.168.190./i)
							{
								open(OUT,">>D:\\log\\$annee-$mois-$jour\\lux2bis$mois.$jour.txt");
								print OUT "$ligne";
							}
											}
				}
